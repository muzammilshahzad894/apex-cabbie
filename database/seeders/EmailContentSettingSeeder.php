    ...
    public function run()
    {
        DB::table('email_content_settings')->insert([
            [
                ...
                'subject' => 'Your Booking with Apex Cabbie is Confirmed!',
                'introductory_message' => 'Thank you for choosing Apex Cabbie for your upcoming journey! We are pleased to confirm your booking:',
                ...
                <p>
                    <a href="{{url}}/term-condition" target="_blank">Terms and Conditions</a>
                </p>',
                'closing_text' => '<p>Best regards</p>
                <p>Apex Cabbie Team</p>',
                'display_order' => 1,
            ],
            [
            ...
            [
                ...
                'subject' => 'Update: Your Apex Cabbie Booking Status',
                'introductory_message' => 'We wanted to inform you that the status of your booking with Apex Cabbie has changed.',
            ...
            [
                ...
                'subject' => 'Refund Request Received for Your Apex Cabbie Booking',
            ...
            [
                ...
                'subject' => 'Update: Your Apex Cabbie Refund Status',
            ...
            [
                'title' => 'quote-request',
                'subject' => 'Your Quote from Apex Cabbie',
