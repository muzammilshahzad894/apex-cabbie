                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                        <div class="btn-group" role="group" aria-label="Action Buttons">
                                            ...
                                            <a href="{{ route('admin.confirm.delete', $draft->id) }}" class="btn btn-danger btn-sm mx-sm-1" onclick="return confirm('Are you sure you want to delete this booking?')" class="btn btn-danger btn-sm mx-sm-1"><i class="fas fa-trash"></i></a>
                                        </div>
                                    </td>
